...
$document->addScript('../assets/midpos/angular/controllers/SupplierProfileController.js');
if (user_group_id() == 1 || has_permission('access', 'read_sell_report')) {
  $document->addScript('../assets/midpos/angular/controllers/ReportSupplierSellController.js');
}
