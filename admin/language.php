...
$document->addScript('../assets/midpos/angular/modals/LanguageCreateModal.js');
$document->addScript('../assets/midpos/angular/modals/LanguageEditModal.js');
$document->addScript('../assets/midpos/angular/controllers/LanguageController.js');
        ...
        <div class="app-row">
          <header class="app-header" style="background: #000;color: #fff;">
            ...
            <?php if ((user_group_id() == 1 || has_permission('access', 'create_language') )&& !DEMO): ?>
              ...
              <div class="btn-group">
                <a class="btn btn-info" href="language.php?lang=<?php echo isset($request->get['lang']) && $request->get['lang'] ? $request->get['lang'] : 'en';?>&recache=1">
                    <span class="fa fa-fw fa-refresh"></span>&nbsp;<?php echo trans('button_recache');?>
                </a>
              </div>
            <?php endif;?>
            </h2>
