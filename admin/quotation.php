...
$reference_no = '';
if (isset($request->get['reference_no'])) {
...
$document->addScript('../assets/midpos/angular/modals/QuotationOptionSelectorModal.js');
$document->addScript('../assets/midpos/angular/modals/QuotationViewModal.js');
$document->addScript('../assets/midpos/angular/controllers/QuotationController.js');
    ...
    <?php if (user_group_id() == 1 || has_permission('access', 'create_quotation')) : ?>
      <div class="box box-info<?php echo create_box_state(); ?>">
        <div class="box-header with-border">
          <h3 class="box-title">
            <?php if ($reference_no):?>
              <span class="fa fa-fw fa-pencil"></span> <?php echo trans('text_edit_quotation_title'); ?> &rarr; <?php echo $reference_no;?>
            <?php else:?>
