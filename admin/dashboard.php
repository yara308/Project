...
$document->addScript('../assets/midpos/angular/controllers/DashboardController.js');
$document->addScript('../assets/midpos/angular/controllers/ReportCollectionController.js');
...
// dd(get_product_suppliers(72));
// dd(get_product_supplier_html(72));
// dd(get_product_supplier_text(72));
