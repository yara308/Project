...
$document->addScript('../assets/midpos/angular/controllers/ReportStockController.js');
		      	...
		      	<div id="reprot_stock_parent_wrapper" class="col-md-12">
			        <div class="box box-info">
			          <div class="box-header with-border">
			            ...
			            <?php if ((!(user_group_id() != 1 && !has_permission('access', 'read_global_stock_report')) || store_filter())) :?>
				            <div class="box-tools pull-right">
				            	<select id="store_id" class="select2 r-50" name="store_id">
									<option value="">
										--- <?php echo trans('text_filter_store'); ?> ---
									</option>
