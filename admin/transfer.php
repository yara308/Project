...
$document->addScript('../assets/midpos/angular/modals/SellOptionSelectorModal.js');
$document->addScript('../assets/midpos/angular/modals/TransferDetailsViewModal.js');
$document->addScript('../assets/midpos/angular/modals/TransferEditModal.js');
$document->addScript('../assets/midpos/angular/controllers/TransferController.js');
