...
$document->addScript('../assets/midpos/angular/controllers/StoreActionController.js');
$document->addScript('../assets/midpos/js/upload.js');
			...
			<div class="box box-success box-no-border">
				<div class="nav-tabs-custom">
			        <ul class="nav nav-tabs store-m15">
						...
						<?php endif; ?>
						<?php if (SHOP):?>
						<li class="<?php echo $tab_active == 'shop_settings' ? 'active' : null;?>">
			          		<a href="#shop_settings" data-toggle="tab" aria-expanded="false">
			          		<?php echo trans('text_shop_settings'); ?>
			       			</a>
			       		</li>
			       		<li class="<?php echo $tab_active == 'social_links' ? 'active' : null;?>">
			          		<a href="#social_links" data-toggle="tab" aria-expanded="false">
			          		<?php echo trans('text_social_links'); ?>
			       			</a>
			       		</li>
			       		<?php endif;?>
			        ...
			        <div class="tab-pane<?php echo $tab_active == 'general' ? ' active' : null;?>" id="general">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
							  <select id="sms_gateway" name="preference[sms_gateway]"> 
							  		<option value="Sparrow" <?php echo get_preference('sms_gateway') == 'Sparrow' ? 'selected' : null; ?>>
										Sparrow
									</option>
						...
						<div class="form-group">
							<label for="remove_expired" class="col-sm-3 control-label">
								<?php echo trans('label_remove_expired_product_from_stock'); ?>
								</span>
							</label>
							<div class="col-sm-7">
							  	<select id="remove_expired" name="preference[remove_expired]"> 
									<option value="no" <?php echo get_preference('remove_expired') == 'no' ? 'selected' : null; ?>>
										<?php echo trans('text_no');?>, I will remove manually
									</option>
									<option value="yes" <?php echo get_preference('remove_expired') == 'yes' ? 'selected' : null; ?>>
										<?php echo trans('text_yes');?>, Remove from stock automatically
									</option>
									<option value="yes" <?php echo get_preference('remove_expired') == 'delete' ? 'selected' : null; ?>>
										<?php echo trans('text_yes');?>, Remove from stock automatically and delete the product
									</option>
								</select>
							</div>
						</div>
					...
					<div class="tab-pane<?php echo $tab_active == 'email-setting' ? ' active' : null;?>" id="email-setting">
						...
						<div ng-show="isSendMail" class="form-group">
							...
							<div class="col-sm-7">
			              		<input type="text" class="form-control" id="send_mail_path" value="<?php echo get_preference('send_mail_path') ? get_preference('send_mail_path') : ''; ?>" name="preference[send_mail_path]">
			              		<p><small>i.e./usr/sbin/sendmail</small></p>
							</div>
						</div>
					...
					<!-- Shop settings start -->
					<div class="tab-pane<?php echo $tab_active == 'shop_settings' ? ' shop_settings' : null;?>" id="shop_settings">
						<div class="form-group">
							<label for="short_description" class="col-sm-3 control-label">
								<?php echo trans('label_short_description'); ?>
							</label>
							<div class="col-sm-7">
								<textarea class="form-control" id="short_description" name="short_description"><?php echo shop('short_description'); ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="about" class="col-sm-3 control-label">
								<?php echo trans('label_about_shop'); ?>
							</label>
							<div class="col-sm-7">
								<textarea class="form-control description" id="about" name="about"><?php echo shop('about'); ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="term_condition" class="col-sm-3 control-label">
								<?php echo trans('label_term_condition'); ?>
							</label>
							<div class="col-sm-7">
								<textarea class="form-control description" id="term_condition" name="term_condition"><?php echo shop('term_condition'); ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="refund_policy" class="col-sm-3 control-label">
								<?php echo trans('label_refund_policy'); ?>
							</label>
							<div class="col-sm-7">
								<textarea class="form-control description" id="refund_policy" name="refund_policy"><?php echo shop('refund_policy'); ?></textarea>
							</div>
						</div>
					</div>
					<!-- Shop settings end -->
					...
					<!-- Social links start -->
					<div class="tab-pane<?php echo $tab_active == 'social_links' ? ' social_links' : null;?>" id="social_links">
						<div class="form-group">
							<label for="preference[facebook]" class="col-sm-3 control-label">
								<?php echo trans('label_facebook'); ?>
							</label>
							<div class="col-sm-7">
			              		<input type="text" class="form-control" id="facebook" value="<?php echo get_preference('facebook'); ?>" name="preference[facebook]">
							</div>
						</div>
						<div class="form-group">
							<label for="preference[twitter]" class="col-sm-3 control-label">
								<?php echo trans('label_twitter'); ?>
							</label>
							<div class="col-sm-7">
			              		<input type="text" class="form-control" id="twitter" value="<?php echo get_preference('twitter'); ?>" name="preference[twitter]">
							</div>
						</div>
						<div class="form-group">
							<label for="preference[youtube]" class="col-sm-3 control-label">
								<?php echo trans('label_youtube'); ?>
							</label>
							<div class="col-sm-7">
			              		<input type="text" class="form-control" id="youtube" value="<?php echo get_preference('youtube'); ?>" name="preference[youtube]">
							</div>
						</div>
						<div class="form-group">
							<label for="preference[linkedin]" class="col-sm-3 control-label">
								<?php echo trans('label_linkedin'); ?>
							</label>
							<div class="col-sm-7">
			              		<input type="text" class="form-control" id="linkedin" value="<?php echo get_preference('linkedin'); ?>" name="preference[linkedin]">
							</div>
						</div>
						<div class="form-group">
							<label for="preference[instagram]" class="col-sm-3 control-label">
								<?php echo trans('label_instagram'); ?>
							</label>
							<div class="col-sm-7">
			              		<input type="text" class="form-control" id="instagram" value="<?php echo get_preference('instagram'); ?>" name="preference[instagram]">
							</div>
						</div>
					</div>
					<!-- Social links end -->
				...
				<form id="uploadlogo" class="upload-form" action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-2 text-center">	            
							<div id="logo_preview">
								<?php if (store('logo')): ?>
									<img id="logo" src="../assets/midpos/img/logo-favicons/<?php echo store('logo'); ?>">
								<?php else: ?>
									<img id="logo" src="../assets/midpos/img/logo-favicons/nologo.png">
								<?php endif; ?>
							</div>
							<p>
								Max. 100 kb
						...
						<?php if (user_group_id() == 1 || has_permission('access', 'upload_logo')) : ?>
						    <div class="col-sm-4">	            
								<div class="upload-field" id="selectImage">
									...
									<img class="loader logo-loader" src="../assets/midpos/img/loading.gif">
								</div>
						    </div>
						<?php endif; ?>
						...
						<div class="col-sm-2 text-center">	            
							<div id="favicon_preview">
								<?php if (store('favicon')): ?>
									<img id="favicon" src="../assets/midpos/img/logo-favicons/<?php echo store('favicon'); ?>">
								<?php else: ?>
									<img id="favicon" src="../assets/midpos/img/logo-favicons/nofavicon.png">
								<?php endif; ?>
							</div>
							<p>
								Max. 50 kb
						...
						<?php if (user_group_id() == 1 || has_permission('access', 'upload_favicon')) : ?>
							<div class="col-sm-4">	            
								<div class="upload-field" id="selectFavicon">
									...
									<img class="loader favicon-loader" src="../assets/midpos/img/loading.gif">
								</div>
							</div>
						<?php endif; ?>
						<div class="clearfix"></div>
