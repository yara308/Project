...
$document->addScript('../assets/midpos/angular/modals/ExpenseCategoryEditModal.js');
$document->addScript('../assets/midpos/angular/modals/ExpenseCategoryDeleteModal.js');
$document->addScript('../assets/midpos/angular/controllers/ExpenseCategoryController.js');
