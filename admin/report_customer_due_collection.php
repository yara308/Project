...
$document->addScript('../assets/midpos/angular/controllers/ReportCustomerDueCollectionController.js');
		      	...
		      	<div class="box box-info">
			      	...
			      	<div class='box-body'>  
						<div class="table-responsive"> 
							...
							?>   
					        <!-- Invoice List Start -->
							<table id="invoice-invoice-list"  class="listing table table-bordered table-striped table-hover" data-hide-colums="<?php echo $hide_colums; ?>">
							    <thead>
							      <tr class="bg-gray">
							        <th class="w-20">
