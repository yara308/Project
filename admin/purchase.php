...
$document->addScript('../assets/midpos/angular/modals/PurchaseOptionSelectorModal.js');
$document->addScript('../assets/midpos/angular/controllers/PurchaseController.js');
...
<div class="content-wrapper" ng-controller="PurchaseController">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <?php if (isset($request->get['box_state']) && $request->get['box_state']=='open'): ?>
        <li class="active">
          <?php if(isset($request->get['invoice_id']) && $request->get['invoice_id']):?>
            <?php echo trans('text_edit'); ?> 
          <?php else:?>
    ...
    <?php if (user_group_id() == 1 || has_permission('access', 'create_purchase_invoice')) : ?>
      <div class="box box-info<?php echo create_box_state(); ?>">
        <div class="box-header with-border">
          <h3 class="box-title">
            <?php if(isset($request->get['invoice_id']) && $request->get['invoice_id']):?>
              <span class="fa fa-fw fa-pencil"></span> <?php echo trans('text_edit_purchase'); ?> &raquo; <span class="text-blue"><?php echo $request->get['invoice_id'];?></span>
            <?php else:?>
          ...
          <div class='box-body'>     
            ...
            <div class="table-responsive"> 
              ...
              if (user_group_id() != 1) {
                ...
                if (! has_permission('access', 'update_purchase_invoice')) {
                  $hide_colums .= "11,";
                }
