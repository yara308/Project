...
$document->addScript('../assets/midpos/angular/modals/OrderViewModal.js');
$document->addScript('../assets/midpos/angular/controllers/OrderController.js');
          ...
          <div class='box-body'>     
            <?php
              ...
              if (user_group_id() != 1) {
                ...
                if (!has_permission('access', 'updadte_approve_status')) {
                  $hide_colums .= "5,";
                }
              }
            ?> 
