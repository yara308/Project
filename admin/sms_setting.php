...
$document->addScript('../assets/midpos/angular/controllers/SMSSettingController.js');
		...
		<form id="sms-setting-form" class="form-horizontal" action="sms_setting.php" method="post">
			...
			<div class="nav-tabs-custom">
		        <ul class="nav nav-tabs store-m15">
		        	<li class="<?php echo get_preference('sms_gateway') == 'Sparrow' ? 'active' : null;?>">
		          		<a href="#sparrow" data-toggle="tab" aria-expanded="false">
		          		<?php echo trans('text_sparrow'); ?>
		       			</a>
		       		</li>
		        ...
		        <div class="tab-content">
		        	<!-- sparrow Setting Start -->
			        <div class="tab-pane <?php echo get_preference('sms_gateway') == 'Sparrow' ? 'active' : null;?>" id="sparrow">
			          	<div class="form-group">
							<label for="sparrow_token" class="col-sm-3 control-label">
								<?php echo trans('label_token'); ?>
							</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="sparrow_token" value="<?php echo sms_setting('sparrow', 'api_id'); ?>" name="setting[sparrow][token]">
							</div>
						</div>
						<div class="form-group">
							<label for="sparrow_identity" class="col-sm-3 control-label">
								<?php echo trans('label_identity'); ?>
							</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="sparrow_identity" value="<?php echo sms_setting('sparrow', 'sender_id'); ?>" name="setting[sparrow][identity]">
							</div>
						</div>
					</div> 
					<!-- sparrow Setting End -->
