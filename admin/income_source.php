...
$document->addScript('../assets/midpos/angular/modals/IncomeSourceEditModal.js');
$document->addScript('../assets/midpos/angular/modals/IncomeSourceDeleteModal.js');
$document->addScript('../assets/midpos/angular/controllers/IncomeSourceController.js');
