...
if (isset($request->get['invoice_id'])) {
  ...
  $products = $model->getInvoiceItems($request->get['invoice_id']);
  $p_array = array();
  $inc = 0;
  foreach ($products as $p) {
    $p_array[$inc]['item_id'] = $p['item_id']; 
    $p_array[$inc]['item_name'] = $p['item_name']; 
    $p_array[$inc]['quantity'] = $p['item_quantity']; 
    $inc++;
  }
  $request->post['products'] = $p_array;
  $request->post['per_page'] = 40;
  $request->post['fields'] = array(
    'site_name' => 1,
    'product_name' => 1,
    'price' => 1,
    'currency' => 1,
...
// Add Style
$document->addStyle('../assets/midpos/css/barcode.css', 'stylesheet', 'all');

// Add Script
$document->addScript('../assets/js/uikit-icons.min.js'); //midpos3 stop here
$document->addScript('../assets/js/uikit.min.js');
$document->addScript('../assets/midpos/angular/controllers/BarcodePrintController.js');
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <select name="per_page" class="form-control" id="per_page">
                        ...
                        <option value="40" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 40 ? 'selected' : 'selected';?>>40 per sheet (a4) (1.53" x 1")</option>
              ...
              if(isset($request->post['products'])):
                ...
                ?>
                  ...
                  <div class="text-center">
                    <div class="btn-group">
                      <button class="btn btn-warning" onClick="window.printContent('barcode-con', {title:'<?php echo trans('text_barcode_print');?>',screenSize:'fullScreen', cssLink:'<link type=\'text/css\' href=\'../assets/midpos/css/barcode.css\' type=\'text/css\' rel=\'stylesheet\'>'});"><span class="fa fa-print"></span> <?php echo trans('button_print');?></button>
                    </div>
                  </div>
                        ...
                        <div class="item-inner">
                          <?php if (isset($request->post['fields']['product_image']) && $request->post['fields']['product_image']):?>
                            <span class="product_image">
                              ...
                              <?php else : ?>
                                <img src="../assets/midpos/img/noimage.jpg">
                              <?php endif; ?>
                            </span>
                          <?php endif;?>
                          <?php if (isset($request->post['fields']['site_name']) && $request->post['fields']['site_name']):?>
                          ...
                          <?php if (isset($request->post['fields']['price']) && $request->post['fields']['price']):?>
                            <div style="font-size:20px;line-height:1.333;font-weight:700;">
                              ...
                              <?php endif;?>
                              <?php echo currency_format($product['sell_price']);?>
                            </div>
                          <?php endif;?>
                          <span class="barcode_image" style="margin-top:5px;">
							 ...
							 <div style="font-size:14px;line-height:1.333;font-weight:700;">
                              <span class="barcode_name"><?php echo $product['p_code'];?></span>
                            </div>
                        </div>
                      </div>
                    <?php 
