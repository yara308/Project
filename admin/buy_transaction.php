...
$document->addScript('../assets/midpos/angular/modals/BuyTransactionViewModal.js');
$document->addScript('../assets/midpos/angular/controllers/BuyTransactionController.js');
...
<div class="content-wrapper" ng-controller="BuyTransactionController">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li>
        <a href="purchase.php"><?php echo $language->get('text_buy_title'); ?></a>  
      </li>
      <li class="active">
        <?php echo $language->get('text_transaction_title'); ?>
      </li>
    </ol>
  </section>
  <!-- Content Header end -->
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <?php echo $language->get('text_transaction_list_title'); ?>
            </h3>
