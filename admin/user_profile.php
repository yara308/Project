...
$document->addScript('../assets/js/uikit.min.js');S
$document->addScript('../assets/midpos/angular/controllers/UserController.js');
$document->addScript('../assets/midpos/angular/controllers/UserProfileController.js');
$document->addScript('../assets/midpos/angular/controllers/ReportUserSellController.js');
$document->addScript('../assets/midpos/angular/controllers/UserLoginLogController.js');
...
<div class="main_content_inner" ng-controller="UserProfileController">
