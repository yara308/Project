...
$document->addScript('../assets/midpos/angular/modals/InstallmentPaymentModal.js');
$document->addScript('../assets/midpos/angular/modals/InstallmentViewModal.js');
$document->addScript('../assets/midpos/angular/modals/CustomerSubstractBalanceModal.js');
$document->addScript('../assets/midpos/angular/modals/CustomerAddBalanceModal.js');
$document->addScript('../assets/midpos/angular/controllers/CustomerController.js');
$document->addScript('../assets/midpos/angular/controllers/CustomerProfileController.js');
