...
<html>
<head>
	<title><?php echo trans('title_reset_data');?>-<?php echo store('name');?></title>
	...
	<div class="container">
		<div class="container-inner">
			<?php if (!empty($errors)):?>
				...
				<?php endforeach;?>				
			<?php endif;?>
			<h2 style="font-size:28px;margin-bottom:15px;" class="title">DATA RESET</h2>
			<h4 class="text">You are going to reset your <?php echo APPNAME;?>. This action will delete all data that can not be restored again. If you still wanna proceed this action then click on 'Yes' otherwise click on 'No' button.</h4>
		</div>
