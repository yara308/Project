...
$document->addScript('../assets/midpos/angular/controllers/InvoiceController.js');
			      	...
			      	<div class='box-body'>  
						...
						<?php
				            ...
				            if (user_group_id() != 1) {
				              ...
				              if (! has_permission('access', 'update_sell_invoice')) {
				                $hide_colums .= "8,";
				              }
						  ...
						  <table id="invoice-invoice-list"  class="table table-bordered table-striped table-hover" data-hide-colums="<?php echo $hide_colums; ?>">
						    <thead>
						      	<tr class="bg-gray">
							        ...
							        <th class="w-25">
							        	<input style="width:100%;border:none;text-align:center;" class="r-50" id="itemName" type="search" name="itemName" placeholder="<?php echo trans('label_product_name');?>">
							        </th>
							        <th class="w-5">
