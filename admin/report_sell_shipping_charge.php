...
// Set Document Title
$document->setTitle(trans('title_shipping_charge_in_sell_report'));

// Add Script
$document->addScript('../assets/js/uikit-icons.min.js'); //midpos3 stop here
$document->addScript('../assets/js/uikit.min.js');
$document->addScript('../assets/midpos/angular/controllers/ReportSellShippingChargeController.js');
...
<div class="content-wrapper" ng-controller="ReportSellShippingChargeController">
<?php include ("rebo.php"); ?>
  <!-- Content Header Start -->
  <section class="content-header">
    <?php include ("../_inc/template/partials/apply_filter.php"); ?>
    <h1>
      <?php echo trans('text_shipping_charge_in_sell_title'); ?>
      <small>
        <?php echo store('name'); ?>
      </small>
    </h1>
