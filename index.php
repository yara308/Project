...
{
  $statement = db()->prepare("INSERT INTO `login_logs` SET `user_id` = 0, `username` = 'unknown', `ip` = ?, `status` = ?, `created_at` = ?");
...
<div class="hidden"><?php include('assets/itsolution24/img/iconmin/membership/membership.svg');?></div>
  ...
  <section class="login-box">
        ...
        <table class="table table-bordered table-striped">
          <tbody>
            <?php foreach (get_users() as $the_user) : ?>
              <?php if (in_array($the_user['email'], array('admin@OnzWo.com', 'cashier@OnzWo.com', 'salesman@OnzWo.com'))) : ?>
                <tr>
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="http://OnzWo.com">OnzWo.com</a>, v<?php echo settings('version'); ?></p>
    </div>
  </section>
