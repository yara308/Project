...
<body class="lockscreen">
  ...
  <div class="lockscreen-wrapper">
    <h4 class="text-center text-green">Onzwo <small class="text-muted">v<?php echo settings('version');?></small></h4>
    <br>
    ...
    <div class="lockscreen-footer text-center">
      <div class="copyright" style="font-size:1.2rem;">Copyright © <?php echo date('Y'); ?> <a href="http://ONZWO.COM">ONZWO.COM</a></div>
    </div>
  </div>
