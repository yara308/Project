...
switch(lang) {
	case "ar":
		langName = "Arabic";
		langUrl = window.baseUrl+"/assets/DataTables/i18n/Arabic.json";
		break;
	case "bn":
		langName = "Bangla";
		langUrl = window.baseUrl+"/assets/DataTables/i18n/Bangla.txt";
		break;
	case "fr":
		langName = "French";
		langUrl = window.baseUrl+"/assets/DataTables/i18n/French.json";
		break;
	case "de":
		langName = "Germany";
		langUrl = window.baseUrl+"/assets/DataTables/i18n/German.json";
		break;
	case "hi":
		langName = "Hindi";
		langUrl = window.baseUrl+"/assets/DataTables/i18n/Hindi.json";
		break;
	case "es":
		langName = "Spanish";
		langUrl = window.baseUrl+"/assets/DataTables/i18n/Spanish.json";
		break;
	default:
      langName = 'English';
      langUrl = window.baseUrl+"/assets/DataTables/i18n/English.json";
      break;
}
...
window.jQuery(window).on("load", function () {
	...
	$("#logout").on("click", function(e) {
		e.preventDefault();
		window.swal({
          title: trans('text_logout'),
          text: trans('alert_do_you_want_to_logout'),
          icon: "warning",
          buttons: true,
          dangerMode: false,
        })
        .then(function(willDelete) {
            if (willDelete) {
                window.location = baseUrl+'/'+adminDir+'/logout.php';
            }
        });
	});
