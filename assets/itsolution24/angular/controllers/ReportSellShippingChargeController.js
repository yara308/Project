window.angularApp.controller("ReportSellShippingChargeController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
...
function (
    ...
    dt.dataTable({
        ...
        "dom": "lfBrtip",
        "serverSide": true,
        "ajax": API_URL + "/_inc/report_sell_shipping_charge.php?from="+$from+"&to="+$to + "&store_id=" + $store_id,
        "fixedHeader": true,
        "order": [[ 0, "desc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: " Shipping Charge in Sell -"+from+" to "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " >  Shipping Charge in Sell -"+from+" to "+to,
                exportOptions: {
                    columns: [printColumns]
                }
            },
            ...
            },
            {
                ...
                titleAttr: "CSV",
                title: window.store.name + " >  Shipping Charge in Sell ",
                exportOptions: {
                    columns: [printColumns]
                }
            },
