...
function (
    ...
    var stockReportDT = $("#report_stock"), $storeID;
    var i;
    ...
    $scope.loadStockReport = function(storeID) {
        ...
        stockReportDT.dataTable({
            ...
            "dom": "lfBrtip",
            "serverSide": true,
            "ajax": API_URL + "/_inc/report_stock.php?from=" + $from + "&to=" + $to + "&store_id=" + $storeID,
            "aaSorting": [],
            "aLengthMenu": [
                [10, 25, 50, 100, 200, -1],
            ...
            "columnDefs": [
                ...
                { 
                    "targets": [1],
                    'createdCell':  function (td, cellData, rowData, row, col) {
                       $(td).attr('data-title', $("#report_stock thead tr th:eq(1)").html());
                    }
                },
                { 
                    "targets": [2],
    ...
    $("#store_id").on('select2:selecting', function(e) {
        $storeID = e.params.args.data.id;
        $scope.loadStockReport($storeID);
    });
