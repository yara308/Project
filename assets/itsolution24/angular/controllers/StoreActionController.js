...
function (
    ...
    $("#update-store-btn").on("click", function(e) {
        ...
        console.log(tinymce.get('term_condition').getContent());
        
        $http({
            url: window.baseUrl + "/_inc/" + actionUrl,
            method: "POST",
            data: form.serialize()+'&about_text='+tinymce.get('about').getContent()+'&term_condition_text='+tinymce.get('term_condition').getContent()+'&refund_policy_text='+tinymce.get('refund_policy').getContent(),
            cache: false,
            processData: false,
            contentType: false,
            dataType: "json"
