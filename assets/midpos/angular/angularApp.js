...
// {{some_text | curConvert:conValue:currencyCode}}
angularApp.filter("curConvert", function () {
    return function (val, conVal, code)
    {
...
if (window.filemanager == 'ftp') {
    window.angular.module("angularApp").config(["fileManagerConfigProvider", function (config) {
        ...
        config.set({
            ...
            tplPath: "../assets/midpos/angular/filemanager/templates",
