...
function (
    ...
    var theDT = $("#invoice-invoice-list").DataTable({
        "oLanguage": {sProcessing:"<img src='../assets/midpos/img/loading2.gif'>", sUrl:langUrl},
        "processing": true,
        "dom": "lfBrtip",
        "serverSide": true,
        'ajax': {
            'url':API_URL + "/_inc/invoice.php?from="+$from+"&to="+$to+"&type="+$type+"&customer_id="+$customerId + "&store_id=" + $store_id,
           'data': function(data){
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Invoice Listing-"+from+" to "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Invoice Listing-"+from+" to "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4 ]
                }
            },
