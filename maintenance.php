...
<body>
    <section id="wrapper">
        ...
        <div id="content">
            <p>System will reset Onzwo data to default. Please, keep patience a bit. We are coming back in live soon!</p>
            <p>&mdash; <a target="_blink" href="https://ONZWO.COM" title="ONZWO.COM">ONZWO.COM</a></p>
        </div>
    </section>
</body>
</html>