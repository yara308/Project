...
// DB table to use
$table = "(SELECT purchase_info.info_id, purchase_info.invoice_id, purchase_info.created_at, purchase_item.item_purchase_price, purchase_item.item_variant_name, purchase_item.item_selling_price, purchase_item.item_quantity, purchase_item.total_sell, purchase_item.return_quantity, purchase_item.status FROM purchase_info 
...
$columns = array(
    ...
    array( 
      'db' => 'item_variant_name',  
      'dt' => 'variant',
      'formatter' => function( $d, $row ) {
        return $row['item_variant_name'];
      }
    ),
    array( 
