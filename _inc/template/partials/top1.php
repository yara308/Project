  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        <?php if (in_array(current_nav(), array('invoice','product_details','report_collection','sell_return','purchase_return','report_sell_itemwise','report_sell_categorywise','report_sell_supplierwise','report_purchase_itemwise','report_purchase_categorywise','report_purchase_supplierwise','report_customer_due_collection','report_payment','expense','expense_monthwise','income_monthwise','supplier_profile','customer_profile','report_overview', 'report_income_and_expense', 'report_profit_loss_summary', 'report_profit_loss', 'report_customer_due_collection', 'report_supplier_due_paid', 'analysis','bank_transactions','bank_transfer','sms_report', 'loan', 'loan_summary', 'purchase','report_sell_tax', 'report_sell_payment','report_purchase_payment','report_purchase_tax','report_tax_overview','giftcard_topup','purchase_log','sell_log','customer_transaction','transfer','installment','report_cashbook', 'quotation', 'installment_payment'))) : ?>
        ...
        <?php endif; ?>
        <li class="user user-menu">
          <a ng-click="SupportDeskModal();" onClick="return false;" href="#" title="<?php echo trans('text_midpos'); ?>">
