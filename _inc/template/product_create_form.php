      ...
      <div class="tab-content">
        ...
        <div class="tab-pane<?php echo $tab_active == 'promotional_price' ? ' active' : null;?>" id="promotional_price">
          ...
          <div class="form-group">
            <label for="has_promotional_price" class="col-sm-2 control-label">
              <?php echo trans('label_has_promotional_price'); ?>
            </label>
            <div class="col-sm-6">
              <div class="checkbox">
                  <input type="checkbox" id="has_promotional_price" value="1" name="has_promotional_price">
              </div>
            </div>
          </div>
          ...
          <table ng-show="hasPromotionalPrice" class="table table-bordered table-condenced table-striped">
            ...
            <tbody>
              ...
              <tr>
                <td ng-click="addPromotionalPriceItem(promotional_priceSerial);" colspan="6" class="text-center bg-info add-promotional_price-row pointer">
        ...
        <div class="tab-pane<?php echo $tab_active == 'variant' ? ' active' : null;?>" id="variant">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <div class="checkbox">
                  <input type="checkbox" id="has_variant" value="1" name="has_variant">
              </div>
            </div>
          </div>
          ...
          <table ng-show="hasVariant" class="table table-bordered table-condenced table-striped">
            <thead>
              <tr class="bg-gray">
                ...
                <td class="w-20 text-center"><?php echo trans('label_purchse_price_addition');?></td>
            ...
            <tbody>
              <tr ng-repeat="variant in variantArray" id="{{ $index }}" class="variant-item">
                ...
                <td class="text-center">
                  <input class="form-control text-center" type="text" name="variant[{{variant.id}}][purchase_price_addition]" id="variant{{variant.purchase_price_addition}}" value="{{ variant.purchase_price_addition }}" onclick="this.select();" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
                </td>
                <td class="text-center">
                  <input class="form-control text-center" type="text" name="variant[{{variant.id}}][sell_price_addition]" id="variant{{variant.sell_price_addition}}" value="{{ variant.sell_price_addition }}" onclick="this.select();" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
                </td>
                <td class="text-center">
        ...
        <div class="tab-pane<?php echo $tab_active == 'general' ? ' active' : null;?>" id="general">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7 supplier-selector">
              ...
              <div class="well well-sm store-well"> 
                <div filter-list="search_supplier">
                  <?php foreach(get_suppliers() as $the_supplier) : ?>                    
                    <div class="checkbox">
                      <label>                         
                        <input type="checkbox" name="supplier[]" value="<?php echo $the_supplier['sup_id']; ?>" <?php echo $the_supplier['sup_id'] == 1 ? 'checked' : null; ?>>
