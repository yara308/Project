					...
					<table class="table table-bordered table-condensed">
						...
						<tbody>
							<tr ng-repeat="items in order.items">
								...
								<td class="w-70">{{ items.item_name }} <span ng-show="items.item_variant_name"> ({{ items.item_variant_name }})</span> x {{ items.item_quantity-items.return_quantity | formatDecimal:2 }}</td>
								<input name="items[{{ items.item_id }}][variant_name]" type="hidden" class="variant-name" value="{{ items.item_variant_name }}">
                    			<input name="items[{{ items.item_id }}][variant_slug]" type="hidden" class="variant-slug" value="{{ items.item_variant_slug }}">
