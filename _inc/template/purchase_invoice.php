		...
		<div class="table-responsive">
			...
			<div class="table-responsive">
				<table class="table table-bordered margin-b0 table-condensed">
					<thead>
					<tr class="bg-gray">
						<th class="w-35"><?php echo trans('label_product'); ?></th>
						<th class="w-10 text-center">
							<?php echo trans('label_ordered'); ?>
						</th>
						<th class="w-10 text-center">
							<?php echo trans('label_received'); ?>
						</th>
						<th class="w-10 text-center">
							<?php echo trans('label_pending'); ?>
						</th>
					...
					<tbody>
						...
						foreach ($invoice_items as $product) : ?>
							<tr>
								<td>
									<?php echo $product['item_name']; ?><?php echo $product['item_variant_name'] ? ' ('.$product['item_variant_name'].')' : null;?> x <?php echo currency_format($product['item_quantity']); ?> <?php echo $product['unitName']; ?>
								</td>
								<td class="text-center">
									<?php echo currency_format($product['item_ordered']); ?>
								</td>
								<td class="text-center">
									<?php echo currency_format($product['item_quantity']); ?>
								</td>
								<td class="text-center">
									<?php echo currency_format($product['item_ordered']-$product['item_quantity']); ?>
								</td>
								<td class="text-right">
					...
					<tbody>
                        <?php $inc=1;foreach ($returns as $row):?>
                          <tr>
                            ...
                            <td class="w-40 text-center"><?php echo $row['item_name'];?><?php echo $row['item_variant_name'] ? ' ('.$row['item_variant_name'].')' : null;?></td>
