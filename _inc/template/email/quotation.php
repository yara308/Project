<!Doctype html>
<head>
    <title>Quotation &rarr; <?php echo $recipient_name; ?></title>
    <meta charset="UTF-8">
...
<body>
    ...
    <p>Thank you for choosing <?php echo $store_name; ?>. Here's the summary of quotation.</p>
    ...
    <div id="quotation">
        ...
        // Qrcode
        $qrcode_text = 'Reference No.: ' . $quotation['reference_no'] . ', Customer: ' . $recipient_name;
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="width:50%;vertical-align:top;">
                            ...
                            <address class="mb-0">
                                <h4 style="font-weight:bold;"><?php echo $recipient_name;?></h4>
