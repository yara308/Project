  ...
  <div class="box-body">
    ...
    <div class="well">
      ...
      <div class="form-group mb-0">
        <label for="due" class="col-sm-3 control-label">
          <?php echo sprintf(trans('label_due'), null); ?>
        </label>
        <div class="col-sm-7">
          <input type="text" class="form-control" id="due" value="0" name="due" onclick="this.select();" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onKeyUp="if(this.value<0){this.value='0';}">
        </div>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-7">
        <input type="number" class="form-control" id="customer_age" value="<?php echo isset($request->post['customer_age']) ? $request->post['customer_age'] : 20; ?>" name="customer_age" onKeyUp="if(this.value>140){this.value='140';}else if(this.value<0){this.value='0';}">
      </div>
    </div>
