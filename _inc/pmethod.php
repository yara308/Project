...
$columns = array(
  ...
  array( 
    ...
    'formatter' => function($d, $row) {
        ...
        $html .= '<input type="checkbox" id="myonoffswitch'.$row['pmethod_id'].'" class="onoffswitch-small-checkbox" name="status"'.$check_status.'data-url="'.root_url().'/_inc/pmethod.php" data-datatable="pmethod-pmethod-list">';
