...
function store_filter() 
{
	...
	return isset($request->get['store_id']) && $request->get['store_id'] && $request->get['store_id'] != 'null' && $request->get['store_id'] != 'undefined';
}
...
function store_id() 
{
	...
	global $request, $store;
	return isset($request->get['store_id']) && $request->get['store_id'] && $request->get['store_id'] != 'null' && $request->get['store_id'] != 'undefined' ? (int)$request->get['store_id'] : $store->get('store_id');
}
