<?php define('APPNAME', 'Modern-POS');define('APPID', 'e0abf0f96f0a466bf985f34d7a38f5e2');
...
require_once DIR_HELPER . 'shop.php';
...
if (defined('INSTALLED') && defined('BLOCKED')) { die("<!DOCTYPE html>
	...
	<body>
		<section id=\"wrapper\">
			...
			<div id=\"content\">
				<p>Your purchase code is not valid. If you have a valid purchase code then claim a valid purchage code here: <a href=\"mailto:midposbd@gmail.com\">midposbd@gmail.com</a> | +8801737346122</p>
				<p style=\"color:blue;\">&mdash; <a style=\"color:green;\" target=\"_blink\" href=\"http://midpos.com\" title=\"midpos.com\">midpos.com</a></p>
			</div>
		</section>
	</body>
	</html>");}
